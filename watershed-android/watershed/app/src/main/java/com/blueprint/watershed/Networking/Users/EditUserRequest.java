...
public class EditUserRequest extends BaseRequest {
    ...
    public EditUserRequest(final Activity activity, User user, HashMap<String, JSONObject> params, final Response.Listener<User> listener) {
        super(Request.Method.PUT, makeObjectURL("users", user), new JSONObject(params),
