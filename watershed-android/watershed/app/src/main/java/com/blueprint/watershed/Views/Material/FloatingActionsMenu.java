package com.blueprint.watershed.Views.Material;
...
public class FloatingActionsMenu extends ViewGroup {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        TypedArray attr = context.obtainStyledAttributes(attributeSet, R.styleable.FABMenu, 0, 0);
        mAddButtonPlusColor = attr.getColor(R.styleable.FABMenu_fab_addButtonPlusIconColor, getColor(android.R.color.white));
        mAddButtonColorNormal = attr.getColor(R.styleable.FABMenu_fab_menu_colorNormal, getColor(android.R.color.holo_blue_dark));
        mAddButtonColorPressed = attr.getColor(R.styleable.FABMenu_fab_menu_colorPressed, getColor(android.R.color.holo_blue_light));
        mAddButtonSize = attr.getInt(R.styleable.FABMenu_fab_addButtonSize, FloatingActionButton.SIZE_NORMAL);
        mAddButtonStrokeVisible = attr.getBoolean(R.styleable.FABMenu_fab_addButtonStrokeVisible, true);
        mExpandDirection = attr.getInt(R.styleable.FABMenu_fab_direction, EXPAND_UP);
        mLabelsStyle = attr.getResourceId(R.styleable.FABMenu_fab_labelStyle, 0);
        mLabelsPosition = attr.getInt(R.styleable.FABMenu_fab_labelsPosition, LABELS_ON_LEFT_SIDE);
        mBackgroundIcon = attr.getResourceId(R.styleable.FABMenu_fab_menu_icon, 0);
        attr.recycle();
