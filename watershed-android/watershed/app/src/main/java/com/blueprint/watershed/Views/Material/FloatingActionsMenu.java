...
public class FloatingActionsMenu extends ViewGroup {
  ...
  private void init(Context context, AttributeSet attributeSet) {
    ...
    mAddButtonColorNormal = attr.getColor(R.styleable.FABMenu_fab_addButtonColorNormal, getColor(android.R.color.holo_blue_dark));
    mAddButtonColorPressed = attr.getColor(R.styleable.FABMenu_fab_addButtonColorPressed, getColor(android.R.color.holo_blue_light));
